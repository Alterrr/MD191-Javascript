...
function runQuiz() {
  ...
  for (var i = 0; i < (quiz.length + 1); i += 1) { //go through quiz
    if (i === quiz.length) {
      document.getElementById("output").innerHTML = (`<h2>You got ${cor} out of ${i} questions right</h2>`) //print evaluation after the last question
    } else {
